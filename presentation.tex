...
\begin{document}
	...
	\begin{frame}{Sistema di raccomandazione - Explainability}
		\textbf{Explainability} del sistema di raccomandazione per \textbf{trasparenza decisionale}:

		\begin{block}{Sistema implementato}
			\begin{itemize}
				\item \textbf{Logging} di ranking e punteggi
				\begin{itemize}
	...
	\begin{frame}{Deploy e frontend - Integrazione con\\ Google Cloud}
		...
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\begin{block}{Google Cloud Functions}
	...
	\begin{frame}{Deploy e frontend - Interfacce frontend}
		Sviluppo di interfacce frontend dedicate per i sistemi implementati:
	...
	\begin{frame}{Ottimizzazione}
			...
			\begin{column}{0.5\textwidth}
				\begin{block}{Miglioramenti}
					\begin{itemize}
						...
						\item Miglioramento dell'algoritmo delle etichette
					\end{itemize}
				\end{block}
			\end{column}
			\begin{column}{0.5\textwidth}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.65\textwidth]{Tabella risultati ottimizzazione.png}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Conclusioni e considerazioni finali}
		Il periodo di \textbf{stage} presso Oribea si è concluso con \textbf{successo}, raggiungendo \textbf{tutti gli obiettivi} prefissati e \textbf{migliorando la Business Intelligence} aziendale.
			...
			\begin{column}{0.48\textwidth}
				\begin{block}{Risultati ottenuti}
					\begin{itemize}
						...
						\item Sviluppate \textbf{interfacce frontend} per collegamento diretto da sito
					\end{itemize}
				\end{block}
			\end{column}
