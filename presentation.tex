	...
	\begin{frame}{Analisi delle vendite - L'idea}
		...
		\begin{columns}
			\begin{column}{0.6\textwidth}
				\begin{itemize}
					\item \textbf{Statistiche utili} - per identificare rapidamente trend e pattern nascosti nei dati
					\item \textbf{Grafici} - perché facilitano la comprensione visuale delle performance aziendali
					\item \textbf{Resoconto dell'andamento} tramite LLM - perché offre interpretazioni testuali intelligenti e personalizzate
				\end{itemize}
			\end{column}
