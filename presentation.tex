...
\begin{document}
	...
	\begin{frame}{Analisi delle vendite - Pipeline per la\\ generazione del report}
		...
		\begin{figure}
			\centering
			\includesvg[width=\textwidth]{Diagramma pipeline analisi delle vendite.svg}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Analisi delle vendite - Formati di output\\ del report}
		...
		\begin{columns}
			\begin{column}{0.33\textwidth}
				...
				\begin{figure}
					\centering
					\includesvg[width=0.7\textwidth]{Diagramma generazione report PDF ReportLab.svg}
				\end{figure}
			\end{column}
			\begin{column}{0.33\textwidth}
				...
				\begin{figure}
					\centering
					\includesvg[width=0.7\textwidth]{Diagramma generazione report HTML Jinja2.svg}
				\end{figure}
			\end{column}
			\begin{column}{0.33\textwidth}
				\begin{block}{Email}
				...
				\begin{figure}
					\centering
					\includesvg[width=0.95\textwidth]{Diagramma invio report via mail SMTP.svg}
				\end{figure}
			\end{column}
		\end{columns}
	\end{frame}
	...
	\begin{frame}{Sistema di raccomandazione - L'idea}
		\begin{columns}
			...
			\begin{column}{0.4\textwidth}
				\begin{figure}
					\centering
					\includesvg[width=\textwidth]{Diagramma Pipeline sistema di raccomandazione.svg}
				\end{figure}
			\end{column}
		\end{columns}
	\end{frame}
