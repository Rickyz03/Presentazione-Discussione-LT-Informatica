...
\begin{document}
	...
	\begin{frame}{Sistema di raccomandazione -\\ Collaborative Filtering}
		...
		\begin{alertblock}{Logica}
			"I clienti con \textbf{gusti simili} nel passato avranno verosimilmente \textbf{preferenze simili} anche in futuro"
		\end{alertblock}
	\end{frame}
	...
	\begin{frame}{Sistema di raccomandazione - Explainability}
		...
		\begin{alertblock}{Sistema di Explainability implementato}
			\textbf{Logging} di rank e punteggio in tutte le classifiche generate, per ciascun prodotto o cliente raccomandato:
			\begin{itemize}
